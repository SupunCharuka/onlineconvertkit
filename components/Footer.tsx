...
export default function Footer() {
    return (
        <footer className="border-t border-zinc-100 dark:border-zinc-800 bg-gradient-to-t from-white/70 dark:from-black/50 backdrop-blur-sm">
            <div className="max-w-6xl mx-auto px-6 py-8 text-sm text-zinc-600 dark:text-zinc-400 flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-600 via-purple-500 to-pink-500 flex items-center justify-center text-white shadow-xl">
                ...
                <div className="hidden sm:flex items-center gap-4">
                    ...
                    <a href="#" className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400">
                ...
                <div className="w-full sm:w-auto mt-4 md:mt-0 text-center">
                    <div className="inline-flex items-center gap-2 bg-white/60 dark:bg-zinc-900/60 px-3 py-1 rounded-full border border-zinc-100 dark:border-zinc-800 shadow-sm">
                        <span className="text-xs text-zinc-700 dark:text-zinc-300">Built with</span>
                        <span className="px-2 py-0.5 rounded bg-indigo-600 text-white text-xs font-medium">Client-side</span>
                    </div>
                </div>
            </div>
        </footer>
